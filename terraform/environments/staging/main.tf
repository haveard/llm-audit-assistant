/*
 * LLM Audit Assistant - Staging Environment Module
 *
 * This module defines resources specific to the staging environment.
 * Staging environment mimics production but with reduced capacity and costs.
 */
...
module "rds" {
  ...
  db_username    = "dbadmin"
  # Smaller instance size for staging
